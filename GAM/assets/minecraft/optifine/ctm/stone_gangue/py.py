...
def split_into_tiles(image_path, output_dir):
    ...
    for y in range(tiles_y):
        for x in range(tiles_x):
            ...
            tile = img.crop(box)
            tile.save(output_dir / f"{i}_n.png")
            i += 1

# Beispiel: aktuelle Datei "bild.png", Kacheln nach "output/" schreiben
split_into_tiles("C:\\Users\\Annhilati\\AppData\\Roaming\\.minecraft\\resourcepacks\\GAM\\assets\\minecraft\\optifine\\ctm\\stone_gangue\\tiles.png",
                 "C:\\Users\\Annhilati\\AppData\\Roaming\\.minecraft\\resourcepacks\\GAM\\assets\\minecraft\\optifine\\ctm\\stone_gangue")
